                  ...
                  <tbody>
                    {reportByAgency.map((a, idx) => (
                      <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="p-2.5 text-right font-mono text-sm text-green-600">{(a.received || 0).toLocaleString('vi-VN')} ₫</td>
                        <td className="p-2.5 text-right font-mono text-sm text-red-600">{(a.due || 0).toLocaleString('vi-VN')} ₫</td>
                        <td className="p-2.5 text-right font-mono text-sm text-orange-600">{(a.discountTotal || 0).toLocaleString('vi-VN')} ₫</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
