  ...
  return (
    <div className="page-container">
      <PageHeader
        ...
        subtitle="Quản lý tất cả tài khoản trong hệ thống"
        action={
      ...
      <ConfirmDialog
        ...
        message={`Bạn có chắc chắn muốn xóa người dùng "${selectedUser?.fullName || selectedUser?.full_name || selectedUser?.name}" không? Hành động này không thể hoàn tác.`}
        confirmText="Xóa"
        variant="danger"
      />
    </div>
